...
export async function SignInOptions() {
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <p className="text-accent text-sm font-semibold">Welcome aboard</p>
      ...
      <div className="mt-7 grid gap-3">
        {users.map(user => (
          <form action={signIn} key={user.id}>
            ...
            <button
              className="border-divider bg-surface hover:border-accent/40 hover:bg-card/60 dark:border-divider-dark dark:bg-black dark:hover:bg-card-dark/60 flex w-full items-center gap-3 rounded-xl border p-3 text-left transition-colors"
              type="submit"
            >
              <span
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="text-muted block text-xs">Demo traveler</span>
              </span>
