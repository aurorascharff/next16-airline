  ...
  return (
    <Boundary label="DemoGuide" asChild>
      <Ariakit.Dialog
        ...
        className="border-divider dark:border-divider-dark fixed top-1/2 left-1/2 z-50 max-h-[85vh] w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-lg border bg-white p-6 shadow-2xl outline-none dark:bg-black"
