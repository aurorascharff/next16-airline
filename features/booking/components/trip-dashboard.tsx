  ...
  return (
    <div className="space-y-10">
      <section className="grid gap-5 lg:grid-cols-[1.35fr_0.65fr]">
        <div className="bg-primary relative min-h-[21rem] overflow-hidden rounded-[2rem] p-7 text-white sm:p-10">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between gap-16">
            ...
            <Link
              ...
              prefetch={true}
            >
              Continue booking <ArrowRight className="size-4" />
            </Link>
          </div>
          <Plane className="absolute right-10 bottom-8 size-28 rotate-[-12deg] text-white/12 sm:size-40" strokeWidth={1} />
        </div>

        <div className="border-divider bg-surface dark:border-divider-dark dark:bg-surface-dark flex flex-col justify-between rounded-[2rem] border p-7">
          <div>
            <div className="bg-mint/20 text-ink dark:text-mint mb-6 grid size-12 place-items-center rounded-2xl">
          ...
          <Link
            ...
            prefetch={true}
          >
            Open trip planner <ArrowRight className="size-4" />
          </Link>
        </div>
      </section>
      ...
      <section>
        ...
        <Link
          className="border-divider bg-surface hover:border-primary/40 dark:border-divider-dark dark:bg-surface-dark group block overflow-hidden rounded-[2rem] border transition-colors"
          href={startHref}
          prefetch={true}
        >
          <div className="grid gap-7 p-6 sm:p-8 lg:grid-cols-[1fr_auto_1fr_auto] lg:items-center">
            <div>
              <p className="text-muted dark:text-muted-dark text-sm">{booking.flight.departureCity}</p>
              <p className="mt-1 text-4xl font-semibold tracking-tight">{booking.flight.departureAirport}</p>
            ...
            <div>
              ...
              <p className="mt-1 text-4xl font-semibold tracking-tight">{booking.flight.arrivalAirport}</p>
          ...
          <div className="bg-card/70 dark:bg-card-dark/70 text-muted dark:text-muted-dark flex items-center gap-2 px-6 py-3 text-xs font-medium sm:px-8">
